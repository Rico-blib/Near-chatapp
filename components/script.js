...
function init() {
  ...
  addRoom("cupa");
  changeRoom("near");
  addMessage("near", "Cupa", "Ola! Open another browser tab, send a chat.", true);
  addMessage("cupa", "Cupa", "This is another room. Nice, yeah?", true);
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room, "Cupa", `Look, your own "${room}" room! Nice.`, true);
  })
